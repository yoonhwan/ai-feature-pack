...
| **기획/문제해결 planner** | **fable-5** 또는 **codex-5.6-sol**(→ft-planner-x) — 세션 인터뷰 선택 | high | 원인 분석·해결 설계 → 설계 파일. max 금지(hang) |
...
| DA(적대검증) | **codex-5.6-sol** 또는 **grok-4.6** — 세션 인터뷰 선택 | high | 게이트 |
