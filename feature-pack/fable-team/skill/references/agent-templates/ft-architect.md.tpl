...
- **표준 체인에서 네 자리 (2026-07-28)**: `checker → 오케(Master) → **architect** → (DA) → 오케 → impl`. **원인 규명과 수정 방향·위치 지정은 네 소관**이고, **DA 소환 여부도 네가 정한다**(오케는 DA를 직접 부르지 않는다). 오케가 넘긴 "의심 방향"은 관찰이지 판정이 아니므로 전제로 받지 말고 실증으로 검증한 뒤 설계한다.
{{EXTRA_INSTRUCTIONS}}
