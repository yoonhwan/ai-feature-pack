...
| Placeholder | 설명 | 에이전트 1개 | 3~5개 | 10개+ |
|-------------|------|------------|-------|-------|
| `{{COLIMA_CPU}}` | CPU 코어 수 | 2 | 4 | 6 |
| `{{COLIMA_MEMORY}}` | RAM (GB) | 4 | 8 | 12 |
| `{{COLIMA_DISK}}` | 디스크 (GB) | 30 | 60 | 100 |

> 사용자에게 질문: "동시에 몇 개 에이전트를 돌릴 예정인가요? (1개 / 3~5개 / 10개+)"
